...
3. Post-fix: 47 focused tests pass, production build passes, representative long PDF is one page, and combined visual comparison shows the requested density improvement.
